    ...
    */
    ...
    _attemptSASLAuth (mechanisms) {
        ...
        for (let i=0; i < mechanisms.length; ++i) {
            ...
            this._sasl_success_handler = this._addSysHandler(
                el => this._sasl_success_cb(el), null,
                "success", null, null);
            this._sasl_failure_handler = this._addSysHandler(
                el => this._sasl_failure_cb(el), null,
                "failure", null, null);
            this._sasl_challenge_handler = this._addSysHandler(
                el => this._sasl_challenge_cb(el), null,
                "challenge", null, null);
    ...
    _attemptLegacyAuth () {
        if (Strophe.getNodeFromJid(this.jid) === null) {
            ...
            this._addSysHandler(
                el => this._onLegacyAuthIQResult(el),
    ...
    bind () {
        ...
        this._addSysHandler(
            elem => this._onResourceBindResultIQ(elem),
    ...
    _establishSession () {
        ...
        this._addSysHandler(
            elem => this._onSessionResultIQ(elem),
