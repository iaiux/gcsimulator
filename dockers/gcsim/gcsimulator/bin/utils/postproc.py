    ...
    def doChecks(self, path, startTime, pathXML, pathVisualizer):
        ...
        for key, value in self.powerPeakListFiles.items():
            if(value.split('/')[-2] != 'EV'):
                ...
                self.powerPeakListFiles[key] = generateEnergyTimeSeries(value, startTime)
...
if __name__ == "__main__":
    ...
    visualization.callExternal("../../Simulations/_dates/10-08-16/" + mydir + "/Results/10_08_16_1")

    checker.doChecks("../../Simulations/_dates/10-08-16/" + mydir + "/Results/10_08_16_1/output", 1475877600,"../../Simulations/_dates/10-08-16/" + mydir + "/Results/10_08_16_1/xml","../../Simulations/_dates/10-08-16/" + mydir + "/Results/10_08_16_1")
    #shutil.copy('../../../../../../dockers/gcsim/gcsimulator/templates/checks.html', 'checks.html')
    html_images("../../Simulations/_dates/10-08-16/" + mydir + "/Results/10_08_16_1/output")
